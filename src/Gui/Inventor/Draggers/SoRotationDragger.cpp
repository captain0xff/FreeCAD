...
void SoRotationDragger::setupArcSensor()
{
    arcSensor.setFunction(arcSensorCB);
    arcSensor.setData(this);
    arcSensor.setPriority(0);
    arcSensor.attach(&arcRadius);
    arcSensor.attach(&arcAngle);
    arcAngle.touch();
}
